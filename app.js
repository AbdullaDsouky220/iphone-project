...
images.addEventListener("click", (e) => {
  ...
  if (e.target.src == `http://${window.location.host}/photos/0.png`) {
    document.body.style.backgroundColor = "#e4bf5d";
  }
  if (e.target.src == `http://${window.location.host}/photos/1.png`) {
    document.body.style.backgroundColor = "#94acc4";
  }
  if (e.target.src == `http://${window.location.host}/photos/2.png`) {
    document.body.style.backgroundColor = "#464541";
  }
  if (e.target.src == `http://${window.location.host}/photos/3.png`) {
    document.body.style.backgroundColor = "#e2ceb3";
  }
  if (e.target.src == `http://${window.location.host}/photos/4.png`) {
